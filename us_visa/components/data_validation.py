...
from us_visa.entities.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from us_visa.entities.config_entity import DataValidationConfig
from us_visa.coonstants import SCHEMA_FILE_PATH
